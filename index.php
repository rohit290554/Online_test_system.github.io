...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.jpg" alt="Rohit" width="400" height="300">
        <p><strong>Rohit Saxena</strong></p>
        <p>PSIT 4th year</p>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> Kanpur, INDIA</p>
      <p><span class="glyphicon glyphicon-phone"></span> +91 9935770848 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> rohitsaxena722@gmail.com</p>
    </div>
...
<script>
function myMap() {
var myCenter = new google.maps.LatLng(00.0000000, 00.0000000);
